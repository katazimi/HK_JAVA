...
<script type="text/javascript">
	function idChk() {
		...
		if (id=="") {
			...
			window.open("idChk.user?id="+id,"아이디 확인","width=300px,height=300px");
		}
	}
...
<body>
	...
	<h1>회원가입</h1>
	<form action="insertUser.user" method="post" onsubmit="return isPW(this)">
		<div class="row mb-3">
			<div class="col-8">
		...
		<div class="row mb-3">
			<div class="col-12">
				...
				<input type="button" onclick="addrIn()" value="우편번호 찾기"><br>
		...
		<div class="row mb-3">
			<div class="col-6">
				<button class="form-control" type="submit">가입완료</button>

			</div>
			<div class="col-6">
				<button class="form-control" type="button" onclick="location.href='index.jsp'">메인</button>
			</div>
		</div>
	</form>
</div>
